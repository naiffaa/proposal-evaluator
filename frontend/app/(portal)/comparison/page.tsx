      ...
      <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground">
            Select an evaluation to compare vendor scores, compliance,
            strengths, gaps, eligibility, and overall ranking.
          </p>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <h2 className="text-sm font-semibold text-primary">
              Compare Vendors by Evaluation
            </h2>

            <p className="mt-1 max-w-3xl text-sm leading-6 text-muted-foreground">
              Vendor comparison is tied to a specific RFP evaluation.
              Select one below to review all evaluated vendors side by side.
            </p>
        ...
        {evaluations.length === 0 ? (
          ...
          <div className="mt-6 border border-border bg-white px-6 py-16 text-center">
            ...
            <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-muted-foreground">
              Start a new proposal evaluation before comparing vendors.
            </p>
          ...
          <div className="mt-6 overflow-hidden border border-border bg-white">
            ...
            <div className="divide-y divide-border">
              ...
              {evaluations.map((evaluation) => (
                ...
                <Link
                  key={evaluation.id}
                  href={`/evaluations/${evaluation.id}/comparison`}
                  className="
                    group
                    grid
                    grid-cols-1
